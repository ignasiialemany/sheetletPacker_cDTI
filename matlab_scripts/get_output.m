function grow_cells_uniform(cells, sheetlet, resx, resy, targetECV, filename)
   ...
   %for kk=1:10
    ...
    %end
    bw_cells_resized = imerode(bw_cells_resized,strel("disk",4));
    ...
    img2 = bw_groups_resized;
    %[img1, img2, new_res] = thicken(img1, bw_groups_resized, 4);
